...
const ChatSessionSchema = new mongoose.Schema({
    ...
    metrics: {
        // Role-specific competencies (6 per role)
        // These are dynamically named based on role but stored generically
        competency1: { type: Number, default: 0 },
        competency2: { type: Number, default: 0 },
        competency3: { type: Number, default: 0 },
        competency4: { type: Number, default: 0 },
        competency5: { type: Number, default: 0 },
        competency6: { type: Number, default: 0 },
